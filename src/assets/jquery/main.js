...
$(document).ready(function () {
   $('.btntoggle').on('click', function() {
       if($(".btntoggle").css("color")=="rgb(0, 0, 0)"){
        $(".btntoggle").css("color", "blue");
//        $(".example-toolbar").css("width", "80%");
     //   $(".maincontent").css("margin-left", "210px");
       }
       else
       {
        $(".btntoggle").css("color", "black");
  //      $(".example-toolbar").css("width", "95%");
   ...
   $(document).ready(function () {
    $('.example-sidenav').mouseenter(function() {
       // $(".example-toolbar").css("width", "80%");
   ...
   $(document).ready(function () {
    $('.example-sidenav').mouseleave(function() {
        if($(".btntoggle").css("color")!="rgb(0, 0, 255)"){
         //   $(".example-toolbar").css("width", "95%");
        }
    });
   });
...
function clock() {
  ...
  // set content of date
  //document.querySelector('.date-tv').innerHTML = year + '-' + month + '-' + day + ' ' + weekDay;
  
  // set content of hour
  document.querySelector('.hr-tv').innerHTML = hr;
  
  // set content of minute
  document.querySelector('.min-tv').innerHTML = min;
  
  // set content of second
  document.querySelector('.sec-tv').innerHTML = sec;
}
